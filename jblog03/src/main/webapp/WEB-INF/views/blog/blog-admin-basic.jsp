	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
					<li class="selected"><a href="${pageContext.request.contextPath }/${blogvo.userId}/admin/basic">기본설정</a></li>
				...
				<form action="${pageContext.request.contextPath }/${blogvo.userId}/basic/update" method="post" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		...
			      		<tr>
			      			<td class="t">&nbsp;</td>
			      			<td><input type="file" name="logo1"></td>      			
			      		</tr>           		
			      		<tr>
			      			<td class="t">&nbsp;</td>
